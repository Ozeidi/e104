...
def Experiment(app, start_e, end_e):
    ...
    fh = logging.FileHandler("Experiment_{}.log".format(app), 'w')
    ...
    ae_disaggregator.train_across_buildings(mains_lst, meters_lst,start_e = start_e, end_e = end_e,
     synthetic_source =sas, sample_period =sp)
    ...
    ############### Evaluation ##########
    #####################################
    measures=['Recall','Precision', 'Accuracy', 'F1','Re. Err. Tot. Eng.','MAE']
