...
WINDOW_PER_BUILDING = {
    1: ("2013-04-12", "2014-12-15"),
    2: ("2013-05-22", "2013-07-03 06:16:00"),
...
def Experiment(app, start_e, end_e):
    ...
    fh = logging.FileHandler("logs/AE_Experiment_{}.log".format(app), 'a')
    ...
    ae_disaggregator.train_across_buildings(mains_lst,epochs = end_e ,sample_period =sp)#,start_e = start_e, end_e = end_e,synthetic_source =sas)
    #export the trained model
    ae_disaggregator.export_model("{}/{}_AE_MODEL.h5".format(save_path,k))
...
#    for k,v in appliances.items():
    ...
    ground_truth =  validation_set.buildings[validation_buidlings].elec.mains()
    ...
    performance.to_csv('{}/{}_AE_performance.csv'.format(save_path,k))
