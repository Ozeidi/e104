...
def Experiment(app, start_e, end_e):
    ...
    print(mains_lst[1].power_series_all_data(sample_period=6))
    ae_disaggregator.train_across_buildings(mains_lst, meters_lst,start_e = start_e, end_e = end_e,sample_period =sp)
